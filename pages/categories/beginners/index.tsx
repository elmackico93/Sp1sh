// pages/categories/beginners/index.tsx
...
export default function CategoryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-4">Beginners</h1>
      <p className="mb-4">Scripts and tutorials for those new to shell scripting.</p>
