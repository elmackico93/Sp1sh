// pages/categories/network/index.tsx
...
export default function CategoryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">Scripts for network configuration, monitoring, and troubleshooting.</p>
