...
export default function CategoryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">Browse scripts for automation tasks and workflows.</p>
